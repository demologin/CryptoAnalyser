package ru.javarush.cryptoanalyzer.kurchavov.view;

import ru.javarush.cryptoanalyzer.kurchavov.commands.Action;
import ru.javarush.cryptoanalyzer.kurchavov.controller.Actions;
...
import static ru.javarush.cryptoanalyzer.kurchavov.constants.Colors.*;
import static ru.javarush.cryptoanalyzer.kurchavov.entity.Result.echoResult;
import static ru.javarush.cryptoanalyzer.kurchavov.util.InputOutput.scanner;
